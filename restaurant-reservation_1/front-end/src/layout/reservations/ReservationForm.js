...
function ReservationForm({
  reservation, // Note this change
  submitHandler,
  handleChange, // Updated to changeHandler
  error,
  isEdit = false
}) {
  ...
  return (
    <>
      <h1>{isEdit ? `Edit Reservation: ${reservation.reservation_id}` : "Create A Reservation"}</h1>
      ...
      <div className="row mb-3">
        ...
        <button type="submit" className="btn btn-primary">{isEdit ? "Submit Edit" : "Submit Reservation"}</button>
      </form>
    </>
  );
}
